...
$appId = OCA\YumiSignNxtC\AppInfo\Application::APP_ID;
OCP\Util::addscript($appId, 'yumisign_nextcloud-adminSettings');
/** @var array $_ */
/** @var OCP\IL10N $l */
?>
<div
  id="yumisign_nextcloud-admin-root"
  data-installed-version  ="<?php echo $_['installed_version'] ?>"
