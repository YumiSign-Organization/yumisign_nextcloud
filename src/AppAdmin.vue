<template>
	...
	*
	...
	<div id="yumisign_nextcloud_main">
		...
		<h3> {{ $t('yumisign_nextcloud', 'Installed version') }} : {{ installedVersion }} </h3>
		<div id="yumisign_nextcloud" class="ymsSettings">
			...
			<div class="ymsSettingsHeader">
				{{ $t('After each settings modification, please save your settings.') }}
			</div>
		...
		<div id="crontab" class="ymsSettings">
			...
			<div class="ymsSettingsHeader">
				...
				<span class="ymsRedNote">
					{{ $t('yumisign_nextcloud', "Please note that for this periodicity to be honored, it is necessary to configure NextCloud background jobs setting with 'Cron' value and to define the crontab periodicity accordingly.") }}
				</span>
			...
			<div class="ymsSettingsPartsContainer">
				<div class="ymsSettingsPart ymsSettingsLabel">
					<label for="cron_interval">{{
						$t('yumisign_nextcloud', 'Periodicity ({min} - {max} mns)', {
