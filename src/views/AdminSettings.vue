...
<template>
	<div id="yumisign_nextcloud_main">
		...
		<div id="appName" class="ymsSettings">
			...
			<div class="ymsSettingsHeader">
				{{ getT('After each settings modification, please save your settings.') }}
			</div>
			<div class="ymsSettingsPartsContainer displayNone">
				<div class="ymsSettingsPart ymsSettingsLabel">
					<label :for="yumisign_server_url">{{ getT('YumiSign server URL') }}</label>
				</div>
				<div class="ymsSettingsPart ymsSettingsInput">
					<span class="deleteicon">
						<input :id="yumisign_server_url" ref="serverUrl" v-model="serverUrl" type="text" :name="yumisign_server_url" maxlength="300" :placeholder="`${placeHolderServerUrl}`" />
			...
			<div class="ymsSettingsPartsContainer">
				...
				<div class="ymsSettingsPart ymsSettingsInput">
					<span class="deleteicon">
						<input id="workspace_name" ref="workspaceName" v-model="workspaceName" type="text" class="deletable" name="workspace_name" maxlength="256" :placeholder="`${placeHolderWorkspaceName}`" />
			...
			<div class="ymsSettingsPartsContainer">
				...
				<div class="ymsSettingsPart ymsSettingsInput">
					<span class="deleteicon">
						<input id="workspace_id" ref="workspaceId" v-model="workspaceId" type="number" class="deletable" name="workspace_id" :placeholder="`${placeHolderWorkspaceId}`" />
		...
		<div id="proxy" class="ymsSettings">
			...
			<div class="ymsSettingsPartsContainer">
				<div class="ymsSettingsLabel" style="display: flex;">
					<NcCheckboxRadioSwitch class="opaChkBox yesNo" :button-variant="true" :checked.sync="useProxy" value="0" name="useProxy" type="radio" button-variant-grouped="horizontal">
						{{ getT('No') }}
						<template #icon>
							<CancelIcon :size="20" />
						</template>
					</NcCheckboxRadioSwitch>
					<NcCheckboxRadioSwitch class="opaChkBox yesNo" :button-variant="true" :checked.sync="useProxy" value="1" name="useProxy" type="radio" button-variant-grouped="horizontal">
						{{ getT('Yes') }}
						<template #icon>
							<CheckIcon :size="20" />
						</template>
			...
			<div class="ymsSettingsPartsContainer">
				...
				<div class="ymsSettingsPart ymsSettingsInput">
					<span class="deleteicon">
						<input id="proxy_host" ref="proxyHost" v-model="proxyHost" type="text" name="proxy_host" maxlength="255" :disabled="!useProxy" />
			...
			<div class="ymsSettingsPartsContainer">
				...
				<div class="ymsSettingsPart ymsSettingsInput">
					<span class="deleteicon">
						<input id="proxy_port" ref="proxyPort" v-model="proxyPort" type="number" name="proxy_port" min="1" max="65535" :disabled="!useProxy" />
			...
			<div class="ymsSettingsPartsContainer">
				...
				<div class="ymsSettingsPart ymsSettingsInput">
					<span class="deleteicon">
						<input id="proxy_username" ref="proxyUsername" v-model="proxyUsername" type="text" name="proxy_username" maxlength="255" :disabled="!useProxy" />
			...
			<div class="ymsSettingsPartsContainer">
				...
				<div class="ymsSettingsPart ymsSettingsInput">
					<span class="deleteicon">
						<input id="proxy_password" ref="proxyPassword" v-model="proxyPassword" type="text" name="proxy_password" maxlength="255" :disabled="!useProxy" />
		...
		<div id="crontab" class="ymsSettings">
			...
			<div class="ymsSettingsHeader">
				...
				<span class="ymsReadMore">
					&#10132;
					<a href="https://docs.nextcloud.com/server/latest/admin_manual/configuration_server/background_jobs_configuration.html#cron" target="_blank">{{ t('yumisign_nextcloud', 'More information here') }}</a>
				</span>
			</div>
...
export default {
	...
	methods: {
		...
		reset_job() {
			...
			this.commonServerPost('/api/v1/settings/job/reset', 'GET').then((response) => {
				this.reqCron.enable = true;
