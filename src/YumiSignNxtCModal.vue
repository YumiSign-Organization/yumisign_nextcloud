					...
					<div v-if="!requesting && !success">
						...
						<div class="flex-container">
							<CheckboxRadioSwitch
								...
								name="recipient_radio"
								type="radio">
								{{ $t('yumisign_nextcloud', 'Signature by a Nextcloud user:') }}
							</CheckboxRadioSwitch>
							<Multiselect v-model="localUser"
...
export default {
	...
	mounted() {
		this.mobileSigningImg = generateFilePath('yumisign_nextcloud', '', 'img/') + 'mobile-signing.png'
