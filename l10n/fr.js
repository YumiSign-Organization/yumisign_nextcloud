OC.L10N.register(
    "yumisign_nextcloud",
    {
    "YumiSign for Nextcloud Settings" : "Paramètres de YumiSign for Nextcloud",
    ...
    "Signed PDF File" : "Fichier PDF signé",
    "Make a signed copy of the original PDF file" : "Faire une copie signée du fichier PDF original",
    "Overwrite the original PDF file with its signed copy" : "Écraser le fichier PDF original avec sa copie signée",
    ...
    "In demo mode, it is only possible to sign PDF files, on which a watermark will be added." : "En mode démonstration, il n’est possible de signer que des fichiers PDF, sur lesquels un filigrane sera ajouté.",
    ...
    "YumiSign for Nextcloud" : "YumiSign for Nextcloud",
    ...
    "Close" : "Fermer",
    "You have to enter the <strong>YumiSign server URL</strong> in the <strong>YumiSign for Nextcloud</strong> settings prior to sign any document." : "Vous devez entrer l’URL du <strong>serveur YumiSign</strong> dans les paramètres <strong>de YumiSign for Nextcloud</strong> avant de signer un document.",
    "Digital seal of file <strong>{filename}</strong>" : "Sceau numérique du fichier <strong>{filename}</strong>",
    "You have to enter the <strong>YumiSign server URL</strong> in the <strong>YumiSign for Nextcloud</strong> settings prior to seal any document." : "Vous devez entrer l’URL du <strong>serveur YumiSign</strong> dans les paramètres <strong>de YumiSign for Nextcloud</strong> avant de sceller tout document.",
