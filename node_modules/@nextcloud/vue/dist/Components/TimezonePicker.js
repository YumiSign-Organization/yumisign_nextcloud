 ...
 * along with this program. If not, see <http://www.gnu.org/licenses/>.
 *
 */var u={data:function(){return{hasStatus:!1,userStatus:{status:null,message:null,icon:null}}},methods:{fetchUserStatus:function(n){var t,e=this;return(t=regeneratorRuntime.mark((function t(){var r,i,a,T,o,E,u,d,D;return regeneratorRuntime.wrap((function(t){for(;;)switch(t.prev=t.next){case 0:if(n){t.next=2;break}return t.abrupt("return");case 2:if(r=Object(l.getCapabilities)(),Object.prototype.hasOwnProperty.call(r,"user_status")&&r.user_status.enabled){t.next=5;break}return t.abrupt("return");case 5:if(Object(c.getCurrentUser)()){t.next=7;break}return t.abrupt("return");case 7:return t.prev=7,t.next=10,s.a.get(Object(A.generateOcsUrl)("apps/user_status/api/v1/statuses/{userId}",{userId:n}));case 10:i=t.sent,a=i.data,T=a.ocs.data,o=T.status,E=T.message,u=T.icon,e.userStatus.status=o,e.userStatus.message=E||"",e.userStatus.icon=u||"",e.hasStatus=!0,t.next=24;break;case 19:if(t.prev=19,t.t0=t.catch(7),404!==t.t0.response.status||0!==(null===(d=t.t0.response.data.ocs)||void 0===d||null===(D=d.data)||void 0===D?void 0:D.length)){t.next=23;break}return t.abrupt("return");case 23:console.error(t.t0);case 24:case"end":return t.stop()}}),t,null,[[7,19]])})),function(){var n=this,e=arguments;return new Promise((function(r,i){var a=t.apply(n,e);function T(n){E(a,r,i,T,o,"next",n)}function o(n){E(a,r,i,T,o,"throw",n)}T(void 0)}))})()}}};
/**
 ...
 * along with this program. If not, see <http://www.gnu.org/licenses/>.
 *
 */t.default=D},function(n,t,e){"use strict";e.r(t);var r=e(59),i=e(66),a=e(2),T=e.n(a),o=e(70),s={insert:"head",singleton:!1};T()(o.a,s),o.a.locals;
/**
 * @copyright Copyright (c) 2018 John Molakvoæ <skjnldsv@protonmail.com>
 *
 * @author John Molakvoæ <skjnldsv@protonmail.com>
 ...
 * along with this program. If not, see <http://www.gnu.org/licenses/>.
 *
 */var d=Object(s.getTimezoneManager)(),D=!1,S=function(){return D||function(){for(var n in c.debug("Using version ".concat(A.version," of the timezone database")),A.zones)if(Object.prototype.hasOwnProperty.call(A.zones,[n])){var t=["BEGIN:VTIMEZONE","TZID:"+n].concat(E(A.zones[n].ics),["END:VTIMEZONE"]).join("\r\n");d.registerTimezoneFromICS(n,t)}for(var e in A.aliases)Object.prototype.hasOwnProperty.call(A.aliases,[e])&&d.registerAlias(e,A.aliases[e].aliasTo);D=!0}(),d};function F(n,t){var e="undefined"!=typeof Symbol&&n[Symbol.iterator]||n["@@iterator"];if(!e){if(Array.isArray(n)||(e=function(n,t){if(!n)return;if("string"==typeof n)return R(n,t);var e=Object.prototype.toString.call(n).slice(8,-1);"Object"===e&&n.constructor&&(e=n.constructor.name);if("Map"===e||"Set"===e)return Array.from(n);if("Arguments"===e||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(e))return R(n,t)}(n))||t&&n&&"number"==typeof n.length){e&&(n=e);var r=0,i=function(){};return{s:i,n:function(){return r>=n.length?{done:!0}:{done:!1,value:n[r++]}},e:function(n){throw n},f:i}}throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}var a,T=!0,o=!1;return{s:function(){e=e.call(n)},n:function(){var n=e.next();return T=n.done,n},e:function(n){o=!0,a=n},f:function(){try{T||null==e.return||e.return()}finally{if(o)throw a}}}}function R(n,t){(null==t||t>n.length)&&(t=n.length);for(var e=0,r=new Array(t);e<t;e++)r[e]=n[e];return r}var N={name:"TimezonePicker",components:{Multiselect:r.default},props:{additionalTimezones:{type:Array,default:function(){return[]}},value:{type:String,default:"floating"}},computed:{placeholder:function(){return Object(i.b)("Type to search time zone")},selectedTimezone:function(){var n,t=F(this.additionalTimezones);try{for(t.s();!(n=t.n()).done;){var e=n.value;if(e.timezoneId===this.value)return e}}catch(n){t.e(n)}finally{t.f()}return{label:o(this.value),timezoneId:this.value}},options:function(){return function(){var n,t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:[],e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:[],r={},T=[],s=a(t);try{for(s.s();!(n=s.n()).done;){var A=n.value,l=A.split("/"),c=[l.shift(),l.join("/")],E=c[0],u=c[1];u||(u=E,E=Object(i.b)("Global")),r[E]=r[E]||{continent:E,regions:[]},r[E].regions.push({label:o(u),cities:[],timezoneId:A})}}catch(n){s.e(n)}finally{s.f()}var d,D=a(e);try{for(D.s();!(d=D.n()).done;){var S=d.value,F=S.continent,R=S.label,N=S.timezoneId;r[F]=r[F]||{continent:F,regions:[]},r[F].regions.push({label:R,cities:[],timezoneId:N})}}catch(n){D.e(n)}finally{D.f()}for(var O in r)Object.prototype.hasOwnProperty.call(r,O)&&(r[O].regions.sort((function(n,t){return n.label<t.label?-1:1})),T.push(r[O]));return T.sort((function(n,t){return n.continent<t.continent?-1:1})),T}(S().listAllTimezones(),this.additionalTimezones)}},methods:{change:function(n){n&&this.$emit("input",n.timezoneId)}}},O=e(2),m=e.n(O),p=e(75),g={insert:"head",singleton:!1},B=(m()(p.a,g),p.a.locals,e(3)),h=e(76),Z=e.n(h),f=Object(B.a)(N,(function(){var n=this.$createElement;return(this._self._c||n)("Multiselect",{attrs:{value:this.selectedTimezone,options:this.options,multiple:!1,"group-select":!1,placeholder:this.placeholder,"group-values":"regions","group-label":"continent","track-by":"timezoneId",label:"label","open-direction":"above"},on:{input:this.change}})}),[],!1,null,"5c87e24c",null);"function"==typeof Z.a&&Z()(f);var Y=f.exports;
/**
