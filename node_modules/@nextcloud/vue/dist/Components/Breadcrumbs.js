 ...
 * along with this program. If not, see <http://www.gnu.org/licenses/>.
 *
 */n.default=p},11:function(t,n,e){"use strict";e.r(n);var i=e(5),o=e(2),a=e.n(o),r=e(13),s={insert:"head",singleton:!1};a()(r.a,s),r.a.locals;
/**
 ...
 * along with this program. If not, see <http://www.gnu.org/licenses/>.
 *
 */n.a=function(t){return Math.random().toString(36).replace(/[^a-z]+/g,"").substr(0,t||5)}},19:function(t,n,e){"use strict";e.r(n);var i=e(14);
/**
 ...
 * along with this program. If not, see <http://www.gnu.org/licenses/>.
 *
 */n.default=i.a},2:function(t,n,e){"use strict";var i,o=function(){return void 0===i&&(i=Boolean(window&&document&&document.all&&!window.atob)),i},a=function(){var t={};return function(n){if(void 0===t[n]){var e=document.querySelector(n);if(window.HTMLIFrameElement&&e instanceof window.HTMLIFrameElement)try{e=e.contentDocument.head}catch(t){e=null}t[n]=e}return t[n]}}(),r=[];function s(t){for(var n=-1,e=0;e<r.length;e++)if(r[e].identifier===t){n=e;break}return n}function l(t,n){for(var e={},i=[],o=0;o<t.length;o++){var a=t[o],l=n.base?a[0]+n.base:a[0],c=e[l]||0,u="".concat(l," ").concat(c);e[l]=c+1;var d=s(u),p={css:a[1],media:a[2],sourceMap:a[3]};-1!==d?(r[d].references++,r[d].updater(p)):r.push({identifier:u,updater:A(p,n),references:1}),i.push(u)}return i}function c(t){var n=document.createElement("style"),i=t.attributes||{};if(void 0===i.nonce){var o=e.nc;o&&(i.nonce=o)}if(Object.keys(i).forEach((function(t){n.setAttribute(t,i[t])})),"function"==typeof t.insert)t.insert(n);else{var r=a(t.insert||"head");if(!r)throw new Error("Couldn't find a style target. This probably means that the value for the 'insert' parameter is invalid.");r.appendChild(n)}return n}var u,d=(u=[],function(t,n){return u[t]=n,u.filter(Boolean).join("\n")});function p(t,n,e,i){var o=e?"":i.media?"@media ".concat(i.media," {").concat(i.css,"}"):i.css;if(t.styleSheet)t.styleSheet.cssText=d(n,o);else{var a=document.createTextNode(o),r=t.childNodes;r[n]&&t.removeChild(r[n]),r.length?t.insertBefore(a,r[n]):t.appendChild(a)}}function m(t,n,e){var i=e.css,o=e.media,a=e.sourceMap;if(o?t.setAttribute("media",o):t.removeAttribute("media"),a&&"undefined"!=typeof btoa&&(i+="\n/*# sourceMappingURL=data:application/json;base64,".concat(btoa(unescape(encodeURIComponent(JSON.stringify(a))))," */")),t.styleSheet)t.styleSheet.cssText=i;else{for(;t.firstChild;)t.removeChild(t.firstChild);t.appendChild(document.createTextNode(i))}}var g=null,h=0;function A(t,n){var e,i,o;if(n.singleton){var a=h++;e=g||(g=c(n)),i=p.bind(null,e,a,!1),o=p.bind(null,e,a,!0)}else e=c(n),i=m.bind(null,e,n),o=function(){!function(t){if(null===t.parentNode)return!1;t.parentNode.removeChild(t)}(e)};return i(t),function(n){if(n){if(n.css===t.css&&n.media===t.media&&n.sourceMap===t.sourceMap)return;i(t=n)}else o()}}t.exports=function(t,n){(n=n||{}).singleton||"boolean"==typeof n.singleton||(n.singleton=o());var e=l(t=t||[],n);return function(t){if(t=t||[],"[object Array]"===Object.prototype.toString.call(t)){for(var i=0;i<e.length;i++){var o=s(e[i]);r[o].references--}for(var a=l(t,n),c=0;c<e.length;c++){var u=s(e[c]);0===r[u].references&&(r[u].updater(),r.splice(u,1))}e=a}}}},231:function(t,n,e){"use strict";e.r(n);var i=e(6),o=e.n(i),a=e(74),r=e.n(a),s=e(53),l=e(106),c=e(105),u=function(t,n,e){if(void 0!==t)for(var i=t.length-1;i>=0;i--){var a=t[i],r=!a.componentOptions&&a.tag&&-1===n.indexOf(a.tag),s=!!a.componentOptions&&"string"==typeof a.componentOptions.tag,l=s&&-1===n.indexOf(a.componentOptions.tag);(r||!s||l)&&((r||l)&&o.a.util.warn("".concat(r?a.tag:a.componentOptions.tag," is not allowed inside the ").concat(e.$options.name," component"),e),t.splice(i,1))}},d=e(107),p=e(16),m={name:"Breadcrumbs",components:{Actions:s.default,ActionRouter:l.default,ActionLink:c.default,Breadcrumb:d.default},props:{rootIcon:{type:String,default:"icon-home"}},data:function(){return{hiddenCrumbs:[],hiddenIndices:[],menuBreadcrumbProps:{title:"",forceMenu:!0,disableDrop:!0,open:!1}}},beforeMount:function(){u(this.$slots.default,["Breadcrumb"],this)},beforeUpdate:function(){u(this.$slots.default,["Breadcrumb"],this)},created:function(){var t=this;window.addEventListener("resize",r()((function(){t.handleWindowResize()}),100)),Object(p.subscribe)("navigation-toggled",this.delayedResize)},mounted:function(){this.handleWindowResize()},updated:function(){this.delayedResize(),this.delayedHideCrumbs()},beforeDestroy:function(){window.removeEventListener("resize",this.handleWindowResize),Object(p.unsubscribe)("navigation-toggled",this.delayedResize)},methods:{delayedHideCrumbs:function(){var t=this;this.$nextTick((function(){var n=t.$slots.default||[];t.hideCrumbs(n)}))},closeActions:function(t){this.$refs.actionsBreadcrumb.$el.contains(t.relatedTarget)||(this.menuBreadcrumbProps.open=!1)},delayedResize:function(){var t=this;this.$nextTick((function(){t.handleWindowResize()}))},handleWindowResize:function(){var t=this.$slots.default||[];if(this.$refs.container){var n=t.length,e=[],i=this.$refs.container.offsetWidth,o=this.getTotalWidth(t)-i;o+=o>0?51:0;for(var a=0,r=Math.floor(n/2);o>0&&a<n-2;){var s=r+(a%2?a+1:a)/2*Math.pow(-1,a+n%2);o-=this.getWidth(t[s].elm),e.push(s),a++}this.arraysEqual(this.hiddenIndices,e.sort((function(t,n){return t-n})))||(this.hiddenCrumbs=e.map((function(n){return t[n]})),this.hiddenIndices=e)}},arraysEqual:function(t,n){if(t.length!==n.length)return!1;if(t===n)return!0;if(null===t||null===n)return!1;for(var e=0;e<t.length;++e)if(t[e]!==n[e])return!1;return!0},getTotalWidth:function(t){var n=this;return t.reduce((function(t,e,i){return t+n.getWidth(e.elm)}),0)},getWidth:function(t){if(!t.classList)return 0;var n=t.classList.contains("crumb--hidden");t.style.minWidth="auto",t.classList.remove("crumb--hidden");var e=t.offsetWidth;return n&&t.classList.add("crumb--hidden"),t.style.minWidth="",e},preventDefault:function(t){return t.preventDefault&&t.preventDefault(),!1},dragStart:function(t){return this.preventDefault(t)},dropped:function(t,n,e){return e||this.$emit("dropped",t,n),this.menuBreadcrumbProps.open=!1,document.querySelectorAll(".crumb").forEach((function(t){t.classList.remove("crumb--hovered")})),this.preventDefault(t)},dragOver:function(t){return this.preventDefault(t)},dragEnter:function(t,n){if(!n&&t.target.closest){var e=t.target.closest(".crumb");if(e.classList&&e.classList.contains("crumb"))document.querySelectorAll(".crumb").forEach((function(t){t.classList.remove("crumb--hovered")})),e.classList.add("crumb--hovered")}},dragLeave:function(t,n){if(!n&&!t.target.contains(t.relatedTarget)&&t.target.closest){var e=t.target.closest(".crumb");if(e.contains(t.relatedTarget))return;e.classList&&e.classList.contains("crumb")&&e.classList.remove("crumb--hovered")}},hideCrumbs:function(t){var n=this,e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:0;t.forEach((function(t,i){var o;null!=t&&null!==(o=t.elm)&&void 0!==o&&o.classList&&(n.hiddenIndices.includes(i+e)?t.elm.classList.add("crumb--hidden"):t.elm.classList.remove("crumb--hidden"))}))}},render:function(t){var n=this,e=this.$slots.default||[];if(0!==e.length){o.a.set(e[0].componentOptions.propsData,"icon",this.rootIcon);var i=[],a=this.hiddenCrumbs.length?e.slice(0,Math.round(e.length/2)):e;i=i.concat(a),this.hideCrumbs(a),this.hiddenCrumbs.length&&i.push(t("Breadcrumb",{class:"dropdown",props:this.menuBreadcrumbProps,ref:"actionsBreadcrumb",key:"actions-breadcrumb-1",nativeOn:{dragstart:this.dragStart,dragenter:function(){n.menuBreadcrumbProps.open=!0},dragleave:this.closeActions},on:{"update:open":function(t){n.menuBreadcrumbProps.open=t}}},this.hiddenCrumbs.map((function(e){var i=e.componentOptions.propsData.to,o=e.componentOptions.propsData.href,a=e.componentOptions.propsData.disableDrop,r="ActionLink",s=o;return i&&(r="ActionRouter",s=i),t(r,{class:"crumb",props:{to:i,href:o,icon:"icon-folder"},attrs:{draggable:!1},nativeOn:{dragstart:n.dragStart,drop:function(t){return n.dropped(t,s,a)},dragover:n.dragOver,dragenter:function(t){return n.dragEnter(t,a)},dragleave:function(t){return n.dragLeave(t,a)}}},e.componentOptions.propsData.title)}))));var r=this.hiddenCrumbs.length?e.slice(Math.round(e.length/2)):[];return i=i.concat(r),this.hideCrumbs(r,a.length),t("div",{class:["breadcrumb",{"breadcrumb--collapsed":this.hiddenCrumbs.length===e.length-2}],ref:"container"},i)}}},g=e(2),h=e.n(g),A=e(166),f={insert:"head",singleton:!1},C=(h()(A.a,f),A.a.locals,e(3)),v=e(167),b=e.n(v),y=Object(C.a)(m,void 0,void 0,!1,null,"11e35494",null);"function"==typeof b.a&&b()(y);var k=y.exports;
/**
 * @copyright Copyright (c) 2020 Raimund Schlüßler <raimund.schluessler@mailbox.org>
 *
 * @author Raimund Schlüßler <raimund.schluessler@mailbox.org>
 ...
 * along with this program. If not, see <http://www.gnu.org/licenses/>.
 *
 */n.default=k},25:function(t,n,e){"use strict";var i=e(6),o=e.n(i);
/**
 * @copyright Copyright (c) 2019 John Molakvoæ <skjnldsv@protonmail.com>
 *
 * @author John Molakvoæ <skjnldsv@protonmail.com>
