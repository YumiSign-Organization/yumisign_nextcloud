...
PO_FILES=$(wildcard translationfiles/*/yumisign_nextcloud.po)
...
translationfiles/templates/yumisign_nextcloud.pot: translationtool.phar $(SRC_FILES) $(LIB_FILES)
	./translationtool.phar create-pot-files
	sed -i "s|$(CURDIR)/||" $@

po: $(PO_FILES) translationfiles/templates/yumisign_nextcloud.pot

translationfiles/%/yumisign_nextcloud.po: translationfiles/templates/yumisign_nextcloud.pot
	msgmerge --update $@ $<
	touch $@
